...
#define JOYSTYICK_AUTO_WALK_ENABLED 0
...
#define KEY_THUMB_0           KEY_LEFT_CTRL
#define KEY_THUMB_1           'r'
#define KEY_THUMB_2           'm'
// Key values for the index finger keys
#define KEY_INDEX_0           KEY_LEFT_SHIFT
#define KEY_INDEX_1           'e'
// Key values for the middle finger keys
#define KEY_MIDDLE_0          'f'
